...
struct rc5_qrk : cvt_qrk<ErrorHandlerT>
{
    ...
    rc5_qrk(uint_least8_t r_val, std::span<KET, EV> key_val, cipher_mode_type cmt_val, std::span<IVET, EV2> iv_val, padding_type pt_val, EHArgTs&& ... ehargs)
...
#include "../detail/ciphers/rc5.hpp"
#include "../detail/utility/basic_block_cipher.hpp"

namespace dataforge {

template <IntegralBasedQuark<8> FromQrkT, size_t W, typename ErrorHandlerT>
struct cvt_resolver<FromQrkT, rc5_qrk<W, ErrorHandlerT>>
{
    using type = generic_block_encrypter<shared_algorithm<basic_block_cipher<rc5_cipher_type_factory<W>>>, ErrorHandlerT>;
};

template <IntegralBasedQuark<8> DestQrkT, size_t W, typename ErrorHandlerT>
struct cvt_resolver<rc5_qrk<W, ErrorHandlerT>, DestQrkT>
{
    using type = generic_block_decrypter<shared_algorithm<basic_block_cipher<rc5_cipher_type_factory<W>>>, ErrorHandlerT>;
};
