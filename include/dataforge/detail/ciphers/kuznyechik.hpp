...
public:
    ...
    explicit kuznyechik_cipher(QrkT const& q);
...
struct kuznyechik_cipher_type_factory
{
    template <typename DerivedT>
    struct apply { using type = kuznyechik_cipher<DerivedT>; };
};

}

#include "kuznyechik.ipp"
